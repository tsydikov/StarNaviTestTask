...
import { SquaresNumber } from './function/function'
...
const [alerts, setAlerts] = useState([])
 ...
 function drawSquares(squaresNumber) {
  ...
  // }
  // console.log(SquaresNumber(squaresNumber))
  // setClassName(SquaresNumber(squaresNumber))
    ...
    <div className="container p-3">
      <div className="row ">
        <div className="col">
          ...
          <Squares hoverOnSquare={hoverOnSquare} squares={squares} className={SquaresNumber(squaresNumber)}/>
        </div>
        <Alert alerts={alerts}/> 
      </div>
    </div>
