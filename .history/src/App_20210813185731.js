...
async function start() {
 ...
 function draw (squaresNumber) {
  ...
  switch (squaresNumber) {
    case 5:React.className.square.width='100px';
    case 10:React.className.square.width='100px';
    case 15:React.className.square.width='100px';
    default:React.className.square.width='100px';
  }
  console.log(squares)
