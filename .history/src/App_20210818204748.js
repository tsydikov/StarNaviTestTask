...
import Squares,{drawSquares} from './components/Squares'
    ...
    <div className="container p-3">
      <div className="row ">
        <div className="col">
          ...
          {/* <Squares /> */}
          <Squares hoverOnSquare={hoverOnSquare} squares={squares=>setSquares(squares)} drawSquares={drawSquares(squaresNumber)}/>
          <div className="row">
            <div className="col">
